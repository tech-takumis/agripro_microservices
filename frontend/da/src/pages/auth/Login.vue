<template>
  <div class="min-h-screen flex flex-col md:flex-row bg-gray-100">
    ...
    >
      ...
      <p class="text-sm text-gray-600 text-center max-w-md leading-relaxed">
        Welcome to the official Department of Agriculture Portal.  
        Please sign in to access your dashboard and manage agricultural programs and resources.
      </p>
    </div>
    ...
    >
      ...
      >
        ...
        <!-- Login Form -->
<form @submit.prevent="submitLogin" class="space-y-5 max-w-sm mx-auto">
  <!-- Username -->
  <div>
    <label
      for="username"
    ...
    <div class="relative">
      ...
      <input
        ...
        :disabled="processing"
        class="w-full pl-9 pr-3 py-2.5 text-sm border border-gray-300 rounded-md placeholder-gray-400 
focus:border-green-400 focus:ring-2 focus:ring-green-400/40 transition duration-200 disabled:opacity-50"

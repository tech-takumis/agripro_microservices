...
<header class="bg-white shadow-sm border-b ">
  <div class="container mx-auto px-6 py-5 flex justify-between items-center">
    <div>
      <h2 class="text-2xl font-bold text-gray-900">Damage Claim Review</h2>
...
<section class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm mt-5">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div>
      ...
      <ul class="space-y-1 text-sm text-gray-800">
        <li><strong>Claim Type:</strong> Crop Damage</li>
        <li><strong>Affected Area:</strong> 12.5 acres</li>
        <li><strong>Estimated Loss:</strong> $25,000</li>
      </ul>
    </div>

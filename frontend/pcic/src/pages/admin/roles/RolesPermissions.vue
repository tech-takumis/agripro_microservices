...
<div class="flex items-center justify-between bg-gray-100 px-6 py-4 border-b border-gray-200 rounded-lg">
  ...
  <div class="flex items-center gap-3">
    ...
    />
    <div>
      <h1 class="text-2xl font-bold text-green-800">Roles and Permission</h1>
      <p class="text-sm text-black-600">Manage user roles and assign permission.</p>
    </div>
  </div>

  <!-- Right: Refresh & Create Role -->
...
>
  ...
  Refresh
    ...
    <button
      @click="openRoleModal()"
      class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm 
                 text-sm font-medium text-white bg-green-800 hover:bg-green-700"
    >
